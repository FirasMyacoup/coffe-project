...
let latte = new Drink("Latte", ["milk", "ice", "sugar"], "./assests/latte.png", true, true, 1);
let mocha = new Drink("mocha", ["milk", "coffee", "ice", "sugar"], "./assests/mocha.png", true, false, 2);
let hotChocalte = new Drink("hot chocalte", ["milk", "coffee", "ice", "sugar"], "./assests/mocha.png", true, false, 2)
